...
class EarthBenchEnv(gym.Env):
    def __init__(self, p1, p2, dims, f1=None, f2=None, constraints_dict=None, max_steps=None, is_test=False, local_search=False, parent_local_search=False):
        self.dims = dims
        ...
        self.target = min(self.f1, self.f2)
    ...
    def _local_search(self, x, y, epochs=200):
        ...
        best_x, best_y = local_search(x, y, epochs=epochs)
        return best_x, best_y

    def load_constraints(self):
        constraints_path = f'Environments/CONOPLib_{self.dims}/constraints.npy'
